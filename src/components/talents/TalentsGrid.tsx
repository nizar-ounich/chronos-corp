...
export default function TalentsGrid() {
  const [activeTab, setActiveTab] = useState<'models' | 'talents'>('models');

  const models = [
    { name: 'Modèle 1', category: 'Mode', type: 'Mannequin' },
    { name: 'Modèle 2', category: 'Beauté', type: 'Mannequin' },
    { name: 'Modèle 3', category: 'Lifestyle', type: 'Acteur/Actrice' },
    { name: 'Modèle 4', category: 'Sport', type: 'Mannequin' },
    { name: 'Modèle 5', category: 'Mode', type: 'Mannequin' },
    { name: 'Modèle 6', category: 'Luxe', type: 'Mannequin' },
  ];
        ...
        <div className="flex justify-center mb-16">
          <div className="inline-flex bg-white/5 rounded-lg p-1">
            <button
              ...
              className={`px-8 py-3 rounded-md text-base font-semibold transition-all duration-200 ${
                activeTab === 'models'
                  ? 'bg-white text-black'
