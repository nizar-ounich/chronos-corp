export default function TalentsBenefits() {
  const benefits = [
    ...
    },
    {
      ...
      description: 'Profitez de conditions financières compétitives pour vos collaborations et partenariats.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
    ...
    },
    {
      ...
      description: 'Rejoignez une communauté de créateurs talentueux et développez votre réseau professionnel.',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
      ...
      description: 'Accédez à des formations et conseils pour améliorer votre contenu et votre stratégie digitale.',
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-lg text-white/70">
            Développez votre carrière avec un accompagnement professionnel et des opportunités exclusives
          </p>
        </div>
